        ...
        <div className="flex flex-col gap-[105px]">
          ...
          <div className=" flex flex-row flex-wrap gap-5">
            <div className="flex-[3] flex flex-col gap-5">
              <div className="flex flex-col gap-5">
                ...
                <div className="text-[16px]">
                  ...
                  est neque totam perferendis quos eaque nesciunt assumenda
                  impedit non quidem omnis, ad, cupiditate maiores ipsam culpa
                  sequi a modi mollitia.
                </div>
              </div>
            ...
            <div className="flex-1 flex flex-col gap-10">
              ...
              <div className="">
                <Button onClick={()=>{}} variant="outline" color="#5B56EF">Apply</Button>
              </div>
            </div>
          </div>
        </div>
